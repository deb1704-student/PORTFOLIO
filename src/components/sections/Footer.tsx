...
export default function Footer() {
    ...
    return (
        <footer aria-label="Site footer" className="relative w-full py-24 px-4 md:px-12 lg:px-24 bg-background z-10 border-t border-white/5 overflow-hidden">
            <div className="max-w-7xl mx-auto flex flex-col justify-between h-full min-h-[60vh]">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-12">
                    ...
                    >
                        ...
                        <p className="font-sans text-foreground/70 max-w-sm font-light">
                                ...
                                <motion.li key={link.label} variants={itemVariants}>
                                    <MagneticLink className="inline-block hoverable">
                                        <a
                                            ...
                                            className="flex items-center gap-2 group text-foreground/80 hover:text-accent transition-colors"
                                        >
                                            <Icon size={16} /> <span>{link.label}</span> <ArrowUpRight size={14} className="opacity-0 group-hover:opacity-100 transition-opacity" />
                                        </a>
                                    </MagneticLink>
                                </motion.li>
                            );
                ...
                <div className="mt-auto pt-32 w-full text-center">
                    <motion.a
                        href={socialLinks.find(l => l.icon === "mail")?.href ?? "#"}
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center mt-12 text-foreground/40 text-xs font-sans tracking-widest uppercase gap-4">
                        <p>&copy; {new Date().getFullYear()} Debanjan Das. All Rights Reserved.</p>
